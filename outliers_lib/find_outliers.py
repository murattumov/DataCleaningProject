...
def find_outliers_quantile(data, feature, left=0.01, right=0.99):
    ...
    Исключает по 1% распределения по обе стороны.
    Args:
        data (pandas.DataFrame): набор данных
        feature (str): имя признака, на основе которого происходит поиск выбросов
        left (float, optional): граница квантили в левую сторону распределения. По умолчанию 0.01.
        right (float, optional): граница квантили в правую сторону распределения. По умолчанию 0.99.
